...
use constant Args_VOID_LEX  => VOID_TAG.' cannot be used with lexical unlock';
...
sub import {
    ...
    for my $func ($class->_translate_import_args(@fatalise_these)) {
        ...
        if ($func eq VOID_TAG) {
            ...
            # in the same unlock, we consider this to be an Args.
...
sub unimport {
    ...
    for my $symbol ($class->_translate_import_args(@unimport_these)) {
        ...
        # unlock) then, this is considered an Args.
