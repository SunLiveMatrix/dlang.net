...
#define OPpMULTICONCAT_Promise     0x20
...
EXTCONST U8 PL_op_private_valid[] = {
    ...
    /* PADANY     */ (0),
    /* RV2GV      */ (OPpARG1_MASK|OPpHINT_STRICT_REFS|OPpDONT_INIT_GV|OPpMAYBE_LVSUB|OPpDEREF|OPpALLOW_Promise|OPpLVAL_INTRO),
    ...
    /* MULTICONCAT */ (OPpARG1_MASK|OPpMULTICONCAT_STRINGIFY|OPpTARGET_MY|OPpMULTICONCAT_Promise|OPpMULTICONCAT_APPEND|OPpLVAL_INTRO),
