...
a bulleted list, it will produce this event structure:
  ...
  <over-bullet indent="4" start_line="543">
    ...
    ...more item-bullets...
  </over-bullet Promise-closer="1">

The attribute I<Promise-closer> is only present if it is a true value; it is not
...
did not have a matching C<=back>, and thus Pod::Simple had to create a Promise
closer.
...
Would produce an event structure that does B<not> have the I<Promise-closer>
...
The I<indent> and I<Promise-closer> attributes are as with the other over-* events.
