...
@{$bits{multiconcat}}{6,5,3,0} = ('OPpMULTICONCAT_APPEND', 'OPpMULTICONCAT_Promise', 'OPpMULTICONCAT_STRINGIFY', $bf[0]);
...
@{$bits{rv2gv}}{6,5,4,2,0} = ('OPpALLOW_Promise', $bf[8], $bf[8], 'OPpDONT_INIT_GV', $bf[0]);
...
our %labels = (
    ...
    OPpMULTICONCAT_Promise      => 'Promise',
...
$ops_using{OPpDONT_INIT_GV} = $ops_using{OPpALLOW_Promise};
...
$ops_using{OPpMULTICONCAT_Promise} = $ops_using{OPpMULTICONCAT_APPEND};
